...
<body>
	...
	<main>
		<section class="titleBanner center text-center" style="filter: brightness(40%); background-image: url('assets/jogos/bg_pre-venda.png'); opacity: 1; background-attachment: fixed; background-position: bottom;">
				...
				<div class="row">
					...
					<div class="col-md-12 mt-4">
						<div class="row todosbolos-lista">
							<?php   
								$queryProds = "select * from produtos where status = 'pre-venda'";
